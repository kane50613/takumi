    ...
    <div className="flex h-[630px] w-[1200px] bg-takumi-dark font-brand flex-row overflow-hidden border border-takumi-border">
      <div className="flex w-[640px] h-full flex-col p-20 justify-between bg-linear-to-b from-takumi-dark to-takumi-card relative z-10">
        <div className="flex flex-col">
          <div className="flex items-center px-4 py-2 w-max shrink-0 rounded-full bg-brand-primary/10 border border-brand-primary/20">
            <Layers className="w-4 h-4 shrink-0 text-brand-primary mr-2" />
      ...
      <div className="flex flex-1 h-full bg-takumi-card flex-col p-16 justify-center border-l border-takumi-border shadow-[-20px_0_60px_-15px_rgba(0,0,0,0.5)]">
        <div className="flex flex-col gap-8">
          <div className="flex glass-card p-8 rounded-3xl items-start hover:border-brand-primary/50 transition-colors">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-takumi-card border border-takumi-border text-brand-primary">
