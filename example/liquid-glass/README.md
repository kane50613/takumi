# Apply a liquid glass shader to a Takumi image
...
![Takumi scene with a liquid glass overlay](output/liquid-glass.webp)
...
The example writes `output/liquid-glass.webp`. Requires Node with WebGPU prebuilds
