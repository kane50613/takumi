...
/// Characters generated by the built-in CSS list marker styles.
#[wasm_bindgen(js_name = listMarkerCharacters)]
pub fn list_marker_characters() -> String {
  takumi_pdf::list_marker_characters().to_string()
}
