...
use crate::options::{
  BAND_EDGE_PADDING, PT_PER_PX, build_metadata, krilla_datetime, validate_custom_xmp,
};
...
pub use crate::options::{
  ...
  PdfDate, PdfError, PdfMetadata, PdfOptions, PdfStandard, Tagging,
};
