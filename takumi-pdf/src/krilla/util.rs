...
use crate::krilla::graphics::color::{DEVICE_CMYK, DEVICE_GRAY, DEVICE_RGB};
use crate::krilla::graphics::paint::Stroke;
use crate::krilla::resource::Resource;
use crate::krilla::serialize::MaybeDeviceColorSpace;
use base64::Engine;
