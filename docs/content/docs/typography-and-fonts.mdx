...
On Node.js (`@takumi-rs/core`), Geist and Geist Mono ship built in. On the browser and edge (`@takumi-rs/wasm`), Manrope ships instead. Add your own family if you need monospace there.
