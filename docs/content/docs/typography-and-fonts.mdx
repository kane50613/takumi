...
For `takumi-js/node` (napi-rs version), full axis Geist and Geist Mono are embedded by default.

For `takumi-js/wasm`, a single variable Latin font, Manrope, is embedded by default.
