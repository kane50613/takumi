...
A reused renderer decodes each file once.
...
Pass an list of object instead of a name to set a family's weight or style:
...
Or you can pass an object for more control:
