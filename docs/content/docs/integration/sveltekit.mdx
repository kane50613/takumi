---
title: SvelteKit
description: Render Svelte components and their CSS as Open Graph images in SvelteKit server routes.
---

Render a Svelte component to HTML on the server, then pass that HTML and its CSS to `ImageResponse`.
