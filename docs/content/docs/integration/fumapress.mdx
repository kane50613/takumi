---
title: Fumapress
description: Generate Open Graph images and page metadata with the built-in Fumapress Takumi plugin.
---
...
For the complete plugin API, see the [Fumapress Takumi reference](https://press.fumadocs.dev/docs/plugins/takumi).
