---
title: Nitro
description: Return Open Graph images from Nitro server routes with Takumi node helpers and ImageResponse.
---

Build an Open Graph image from a node tree and return it from a Nitro route. The helpers below work without JSX.
