...
Node.js fetch (via [undici](https://github.com/nodejs/undici)) can fail intermittently — see [#349](https://github.com/kane50613/takumi/issues/349). Use the [Bun](https://bun.sh) runtime instead.
  </Accordion>
</Accordions>
