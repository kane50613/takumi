---
title: Charts
description: Render ECharts and other SVG charts as PNG images or PDF documents with Takumi.
icon: ChartColumn
---
...
```tsx twoslash title="Render a chart to PNG"
...
```tsx twoslash title="Load chart label fonts"
