...
On a Node.js host that can't load a native addon (a WebContainer, an unsupported platform), build a WASM renderer and pass it as `renderer`:

```tsx twoslash
import { render } from "takumi-js";
import { createRenderer } from "takumi-js/wasm";
