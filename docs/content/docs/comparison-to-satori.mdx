...
| :-------------------------------------- | :----------------------- | :------------------------------------------------------------- |
| **Template input**                      | JSX                      | JSX, **HTML strings**, JSON node trees from any language       |
| **Styling**                             | Inline styles, `tw` prop | Inline styles, `tw` prop, **`<style>` tags, full stylesheets** |
| **Selectors**                           | ❌                       | ✅ class, id, descendant, `:is()`, `::before`, `::after`       |
...
| Feature                 | satori / `next/og`   | Takumi                                                  |
| :---------------------- | :------------------- | :------------------------------------------------------ |
| **Default font**        | ❌ `fonts` required  | ✅ built-in (Geist, Latin only)                         |
| **WOFF2**               | ❌                   | ✅                                                      |
| **Emoji**               | `graphemeImages` map | ✅ **six built-in providers**                           |
| **Runtime**             | Node, Edge, browser  | Node, Edge, Cloudflare Workers, browser, **Rust crate** |
