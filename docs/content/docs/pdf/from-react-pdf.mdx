...
description: Migrate @react-pdf/renderer templates to takumi-pdf using HTML elements, CSS, and page options.
icon: Atom
---
...
```tsx title="Before: react-pdf primitives"
// @react-pdf/renderer
...
```tsx twoslash title="After: HTML elements and CSS"
// takumi-pdf
...
```tsx twoslash title="Repeat page headers"
