...
| Property                                            | Values                                                                                                                                                                                                                                |
| :-------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `display`                                           | `none`, `flex`, `inline-flex`, `grid`, `inline-grid`, `block`, `inline-block`, `inline`, `list-item`, `table`, `table-header-group`, `table-row-group`, `table-footer-group`, `table-row`, `table-cell`, `table-caption` <sup>1</sup> |
...
<sup>1</sup> The table display values use a naive grid-based implementation, not the CSS table
algorithm. See [Tables](/docs/tables) for what carries over and where it drifts.
...
| Property                                                                                                                                                         | Values                                                                                                        |
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------ |
| `animation` (`animationName`, `animationDuration`, `animationDelay`, `animationIterationCount`, `animationDirection`, `animationFillMode`, `animationPlayState`) | Supported                                                                                                     |
