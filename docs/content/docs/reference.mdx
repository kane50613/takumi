...
<sup>1</sup> The table displays are a naive implementation: the table is lowered onto the grid
algorithm, not the CSS table algorithm. See [Tables](/docs/tables) for what carries over and where
it drifts.
