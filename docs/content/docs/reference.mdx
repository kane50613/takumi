...
| `contain`                                                            | `none`, `strict`, `content`, `size`, `inline-size`, `layout`, `style`, `paint` <sup>2</sup>                                                                                                                                                        |
| `content`                                                            | Supported                                                                                                                                                                                                                                          |
...
<sup>2</sup> Only `layout` and `paint` containment affect layout, by making the box an independent
formatting context. `size`, `inline-size` and `style` parse and serialize but do nothing, so
`strict` behaves like `layout paint`.
