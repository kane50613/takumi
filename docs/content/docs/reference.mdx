...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>`border`</td>
      <td>`borderWidth` (`borderTopWidth`, `borderRightWidth`, `borderBottomWidth`, `borderLeftWidth`, `borderInlineWidth`, `borderBlockWidth`), `borderColor`</td>
    ...
    <tr>
      ...
      <td>`blur()`, `brightness()`, `contrast()`, `drop-shadow()`, `grayscale()`, `hue-rotate()`, `invert()`, `opacity()`, `saturate()`, `sepia()`</td>
    </tr>
    <tr>
      <td colSpan={2}>`backdropFilter`</td>
      <td>`blur()`, `brightness()`, `contrast()`, `grayscale()`, `hue-rotate()`, `invert()`, `opacity()`, `saturate()`, `sepia()`</td>
    </tr>
    <tr>
