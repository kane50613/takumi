...
<TypeTable
  type={{
    ...
    style: {
      type: "'normal' | 'italic' | 'oblique' | `oblique ${number}deg` | (string & {})",
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>`none`, `flex`, `inline-flex`, `grid`, `inline-grid`, `block`, `inline-block`, `inline`</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>`gridColumn` (`gridColumnStart`, `gridColumnEnd`)</td>
      <td>Supported</td>
    </tr>
    <tr>
      <td>`gridRow` (`gridRowStart`, `gridRowEnd`)</td>
      <td>Supported</td>
    </tr>
    <tr>
      <td>`gridArea` (`gridRowStart`, `gridColumnStart`, `gridRowEnd`, `gridColumnEnd`)</td>
      <td>Supported</td>
    </tr>
    <tr>
    ...
    <tr>
      <td rowSpan={4}>`textDecoration`</td>
