...
Refer to both [Typography & Fonts](/docs/guides/typography) and [Load Images](/docs/guides/images) for more details.
...
Loading images from URLs or bytes during the rendering pass can be a bottleneck. Register [Load Images](/docs/guides/images) to avoid re-decoding.
