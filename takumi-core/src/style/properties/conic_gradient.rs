...
pub struct ConicGradient {
  ...
  #[builder(default = ColorInterpolationMethod::for_stop_syntax(false))]
    ...
    input.parse_nested_block(|input| {
      ...
      Ok(ConicGradient {
        ...
        interpolation: interpolation
          .unwrap_or_else(|| ColorInterpolationMethod::for_stop_syntax(modern)),
    ...
    for (input, stops) in [
      ...
      assert_eq!(
        ...
        Ok(ConicGradient {
          ...
          interpolation: ColorInterpolationMethod::for_stop_syntax(false),
          stops: stops.into(),
        }),
        "input: {input}",
      );
