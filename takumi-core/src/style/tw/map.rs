...
pub(crate) static FIXED_PROPERTIES: phf::Map<&str, TailwindProperty> = phf_map! {
  ...
  "contain-strict" => TailwindProperty::Contain(Contain::STRICT),
  "contain-content" => TailwindProperty::Contain(Contain::CONTENT),
  "contain-size" => TailwindProperty::Contain(Contain::SIZE),
  "contain-inline-size" => TailwindProperty::Contain(Contain::INLINE_SIZE),
