...
pub(crate) static PREFIX_PARSERS: phf::Map<&str, &[PropertyParser]> = phf_map! {
  ...
  "w" => &[PropertyParser::Size(TailwindProperty::Width)],
  "h" => &[PropertyParser::Size(TailwindProperty::Height)],
  ...
  "size" => &[PropertyParser::Size(TailwindProperty::Size)],
  "font" => &[
  ...
  "basis" | "flex-basis" => &[PropertyParser::FlexBasis(TailwindProperty::FlexBasis)],
...
pub(crate) static FIXED_PROPERTIES: phf::Map<&str, TailwindProperty> = phf_map! {
  ...
  "flow-root" => TailwindProperty::Display(Display::FlowRoot),
  ...
  "w-screen" => TailwindProperty::Width(Size::Length(Length::Vw(100.0))),
  "h-screen" => TailwindProperty::Height(Size::Length(Length::Vh(100.0))),
  ...
  "shadow-none" => TailwindProperty::ShadowNone,
  ...
  "inset-shadow-none" => TailwindProperty::ShadowNone,
  ...
  "text-shadow-none" => TailwindProperty::TextShadowNone,
  "contain-none" => TailwindProperty::Contain(Contain::NONE),
  "contain-content" => TailwindProperty::Contain(Contain::CONTENT),
  "contain-layout" => TailwindProperty::Contain(Contain::LAYOUT),
  "contain-style" => TailwindProperty::Contain(Contain::STYLE),
  "contain-paint" => TailwindProperty::Contain(Contain::PAINT),
