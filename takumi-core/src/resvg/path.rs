...
use crate::resvg::render::Context;

pub fn render(
  path: &crate::resvg::usvg::Path,
  ...
  if path.paint_order() == crate::resvg::usvg::PaintOrder::FillAndStroke {
...
pub fn fill_path(
  ...
  let rule = match fill.rule() {
    crate::resvg::usvg::FillRule::NonZero => tiny_skia::FillRule::Winding,
    crate::resvg::usvg::FillRule::EvenOdd => tiny_skia::FillRule::EvenOdd,
  };

  let pattern_pixmap;
  let mut paint = tiny_skia::Paint::default();
  match fill.paint() {
    crate::resvg::usvg::Paint::Color(c) => {
      paint.set_color_rgba8(c.red, c.green, c.blue, fill.opacity().to_u8());
    }
    crate::resvg::usvg::Paint::LinearGradient(lg) => {
      paint.shader = convert_linear_gradient(lg, fill.opacity())?;
    }
    crate::resvg::usvg::Paint::RadialGradient(rg) => {
      paint.shader = convert_radial_gradient(rg, fill.opacity())?;
    }
    crate::resvg::usvg::Paint::Pattern(pattern) => {
...
fn convert_linear_gradient(
  gradient: &crate::resvg::usvg::LinearGradient,
  opacity: crate::resvg::usvg::Opacity,
...
fn convert_radial_gradient(
  gradient: &crate::resvg::usvg::RadialGradient,
  opacity: crate::resvg::usvg::Opacity,
) -> Option<tiny_skia::Shader<'_>> {
  let (mode, points) = convert_base_gradient(gradient, opacity)?;
...
fn convert_base_gradient(
  gradient: &crate::resvg::usvg::BaseGradient,
  opacity: crate::resvg::usvg::Opacity,
) -> Option<(tiny_skia::SpreadMode, Vec<tiny_skia::GradientStop>)> {
  let mode = match gradient.spread_method() {
    crate::resvg::usvg::SpreadMethod::Pad => tiny_skia::SpreadMode::Pad,
    crate::resvg::usvg::SpreadMethod::Reflect => tiny_skia::SpreadMode::Reflect,
    crate::resvg::usvg::SpreadMethod::Repeat => tiny_skia::SpreadMode::Repeat,
  };
...
fn render_pattern_pixmap(
  pattern: &crate::resvg::usvg::Pattern,
  ctx: &Context,
  transform: tiny_skia::Transform,
  ...
  crate::resvg::render::render_nodes(pattern.root(), ctx, transform, &mut pixmap.as_mut());
