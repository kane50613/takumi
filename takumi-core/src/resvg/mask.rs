...
pub fn apply(
...

  {
    ...
    crate::resvg::render::render_nodes(mask.root(), ctx, transform, &mut mask_pixmap.as_mut());
  ...
  let mask_type = match mask.kind() {
    crate::resvg::usvg::MaskType::Luminance => tiny_skia::MaskType::Luminance,
    crate::resvg::usvg::MaskType::Alpha => tiny_skia::MaskType::Alpha,
  };
